...
export const metadata = {
  title: 'Growth Platform (Test Live) — Texas AI',
  description: 'Live-Stripe integration test page. Not for real orders.',
    ...
    <main className="section-txai">
      ...
      <div className="section-container-txai animate-fade-up-txai" style={{ marginTop: '40px' }}>
          ...
          <div className="grid-txai">
            ...
            <div style={{ flex: 1, padding: '20px', borderLeft: '2px solid #ebcb4c' }}>
              ...
              <ul style={{ listStyle: 'none', padding: 0 }}>
                ...
                <li style={{ marginTop: '10px', fontWeight: 'bold', color: '#ebcb4c' }}>TOTAL: $1.50/MO (TEST)</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '60px' }}>
          <Link href="/funnels/growth-platform-test-live/agreement">
