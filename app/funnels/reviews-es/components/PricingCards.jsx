...
export default function PricingCards({ billing = 'monthly', funnelBase = '/funnels/reviews-es' }) {
  const { display, features, trial } = REVIEWS_ES_STRIPE_CONFIG
  ...
  return (
    ...
    >
      {TIER_ORDER.map((tierKey) => {
        ...
        const cadence = billing === 'monthly' ? '/mes' : '/año'
