      ...
      <main className='container mx-auto max-w-4xl px-4 py-10'>
        <article className='rounded-2xl bg-white p-6 leading-relaxed text-gray-800 shadow-xl md:p-10'>
          <section className='mb-8'>
            <h2 className='mb-3 text-2xl font-bold text-ai-navy'>SMS Messaging Terms &amp; Compliance</h2>

            <h3 className='mb-2 mt-4 text-lg font-semibold text-ai-navy'>1. Program Description</h3>
            <p>
            ...
            <h3 className='mb-2 mt-4 text-lg font-semibold text-ai-navy'>2. Cancellation Instructions</h3>
            <p>
            ...
            <h3 className='mb-2 mt-4 text-lg font-semibold text-ai-navy'>3. Support Information</h3>
            <p>
            ...
            <h3 className='mb-2 mt-4 text-lg font-semibold text-ai-navy'>4. Carrier Liability</h3>
            <p>Carriers are not liable for delayed or undelivered messages.</p>

            <h3 className='mb-2 mt-4 text-lg font-semibold text-ai-navy'>5. Message &amp; Data Rates</h3>
            <p>
            ...
            <h3 className='mb-2 mt-4 text-lg font-semibold text-ai-navy'>6. Supported Carriers</h3>
            <p>
            ...
            <h3 className='mb-2 mt-4 text-lg font-semibold text-ai-navy'>7. Age Restriction</h3>
            <p>You must be 18 years or older to participate in our SMS program.</p>

            <h3 className='mb-2 mt-4 text-lg font-semibold text-ai-navy'>8. Privacy Policy</h3>
            <p>
              For privacy-related inquiries, please refer to our{' '}
              <Link className='text-ai-blue underline' href='/privacy-policy'>
                Privacy Policy
              </Link>
              .
            </p>
          ...
          <section className='mb-8'>
            <h2 className='mb-3 text-2xl font-bold text-ai-navy'>General Terms</h2>
            <p className='mb-3'>
          ...
          <section className='mb-8'>
            <h2 className='mb-3 text-2xl font-bold text-ai-navy'>Intellectual Property Rights</h2>

            <h3 className='mb-2 mt-4 text-lg font-semibold text-ai-navy'>Our Limited License to You</h3>
            <p className='mb-3'>
            ...
            <h3 className='mb-2 mt-4 text-lg font-semibold text-ai-navy'>Your License to Us</h3>
            <p>
          ...
          <section className='mb-8'>
            <h2 className='mb-3 text-2xl font-bold text-ai-navy'>Disclaimers</h2>
            <p className='mb-3'>
          ...
          <section className='mb-8'>
            <h2 className='mb-3 text-2xl font-bold text-ai-navy'>Online Commerce</h2>
            <p className='mb-3'>
          ...
          <section className='mb-8'>
            <h2 className='mb-3 text-2xl font-bold text-ai-navy'>Registration &amp; Passwords</h2>
            <p className='mb-3'>
          ...
          <section className='mb-8'>
            <h2 className='mb-3 text-2xl font-bold text-ai-navy'>Termination</h2>
            <p>
          ...
          <section className='mb-8'>
            <h2 className='mb-3 text-2xl font-bold text-ai-navy'>Governing Law</h2>
            <p>
          ...
          <section className='mb-2'>
            <h2 className='mb-3 text-2xl font-bold text-ai-navy'>Changes to Terms of Service</h2>
            <p className='mb-3'>
