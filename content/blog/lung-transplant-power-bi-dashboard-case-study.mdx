...
<div className="my-8 overflow-x-auto rounded-lg border border-[#2c75ff]">
  <table className="w-full border-collapse text-left">
    ...
    <tbody>
      ...
      <tr>
        <td>Enterprise clinical repository</td>
        <td>HCA Health Integrated Network (HIN)</td>
        <td>Shared clinical data repository used by enterprise EHRs, including TeleResults and MEDITECH</td>
      </tr>
      <tr>
