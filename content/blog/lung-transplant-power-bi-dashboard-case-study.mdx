...
<div className="p-4 my-6 bg-[#0e2042] rounded-lg border border-[#2c75ff]">
  ...
  <div className="text-white mb-0">
    Two disconnected clinical sources became one daily-refreshed Power BI surveillance application built around alerts, protocols, and clinical workflow.
  </div>
</div>
...
| Layer | Technology | Role in the solution |
|---|---|---|
| Transplant EHR | TeleResults and SQL Server | Transplant dates, clinic activity, labs, pulmonary function, and patient-level surveillance fields |
| Enterprise clinical network | HCA HIN and Google BigQuery | Radiology and imaging information not available in the transplant EHR source |
| Semantic and reporting layer | Power BI Service | Governed model, daily refresh, alerts, trends, protocol views, and clinical huddle workflow |
...
Every protocol item also carries a source status:

- **Mapped** means the metric is backed by an established data source.
- **Partial** means part of the requirement is available, but the mapping is incomplete.
- **Source pending** means the completion source still needs to be established.
